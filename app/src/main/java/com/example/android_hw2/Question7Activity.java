...
public class Question7Activity extends AppCompatActivity {
  ...
  //  int score1 = getIntent().getIntExtra("score", 0);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Answer1Button= (Button) findViewById(R.id.Q7button1);
        ...
        Answer2Button= (Button) findViewById(R.id.Q7button2);
        ...
        Answer3Button= (Button) findViewById(R.id.Q7button3);
        ...
        Answer4Button= (Button) findViewById(R.id.Q7button4);
