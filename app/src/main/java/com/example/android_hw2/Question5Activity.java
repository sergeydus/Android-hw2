...
public class Question5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Answer1Button= (Button) findViewById(R.id.Q5button1);
        ...
        Answer2Button= (Button) findViewById(R.id.Q5button2);
        ...
        Answer3Button= (Button) findViewById(R.id.Q5button3);
        ...
        Answer4Button= (Button) findViewById(R.id.Q5button4);
